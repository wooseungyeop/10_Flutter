...
class MainApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        ...
        home: const ScaffoldCistom()
    );
  }
}

class ScaffoldCistom extends StatelessWidget{
  const ScaffoldCistom({super.key});
      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            ...
            child: const Icon(Icons.favorite),// Icon 위젯은 아이콘을 화면에 표시하기 위한 위젯이다.
          )// appBar의 오른쪽 끝에 표시될 위젯 목록이다. 보통 아이콘 버튼이나 메뉴를 추가한다.
